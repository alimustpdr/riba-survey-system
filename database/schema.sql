...
CREATE TABLE IF NOT EXISTS surveys (
    ...
    gender_field_enabled BOOLEAN DEFAULT TRUE,
...
-- Not: `surveys` tablosuna FK olduğu için `surveys` oluşturulduktan sonra gelmelidir.
